...
uv run python pipeline/main.py \
    --exp_desc Llama-2-7b-hf__mello__CF-3k_1000 \
    --pipeline_config_dir configs/pipeline_config/Llama-2-7b-hf/mello.json \
    ...
    --output_folder_dir ${output_folder_root_dir}/mquake_remastered/Llama-2-7b-hf/mello/CF-3k_1000/
