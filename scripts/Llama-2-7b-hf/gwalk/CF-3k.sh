...
uv run python pipeline/main.py \
    --exp_desc Llama-2-7b-hf__gwalk__CF-3k_1000 \
    --pipeline_config_dir configs/pipeline_config/Llama-2-7b-hf/gwalk.json \
    ...
    --output_folder_dir ${output_folder_root_dir}/mquake_remastered/Llama-2-7b-hf/gwalk/CF-3k_1000/
