...
uv run python pipeline/main.py \
    --exp_desc Mistral-7B-Instruct-v0.2__gwalk__CF-3k_1000 \
    ...
    --output_folder_dir ${output_folder_root_dir}/mquake_remastered/Mistral-7B-Instruct-v0.2/gwalk/CF-3k_1000/
