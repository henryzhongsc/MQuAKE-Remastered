...
import pipeline.mello.eval_loop as eval_loop


def eval_mello(config):
    ...
    result_summary_str, raw_answer_dict = eval_loop.mello_eval_loop(eval_var, config)
    ...
    logger.info(f"MeLLo evaluation complete: {result_summary_str}")
