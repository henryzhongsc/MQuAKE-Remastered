...
def initialize_model_tokenizer(pipeline_config):
    ...
    model = AutoModelForCausalLM.from_pretrained(pipeline_config['model_name'], device_map="auto", attn_implementation=attn_implementation, torch_dtype=torch.bfloat16, token=hf_access_token)
